<div class="container">
    <div>
        <p style="padding-left: 11px; font-family: UTM; font-weight: bold; font-size: 25px; line-height: 31px; color: #505353"> Reviews</p>
    </div>
    <div class="row">
                    ...
                    <div class="col-lg-9 col-xs-12 col-md-6" style="left: 60px">
                        <div class="row rating-desc">
                            ...
                            <div class="col-lg-1 col-xs-3 col-md-3 text-left" style="padding-left: 0px">
                                <span class="glyphicon glyphicon-star" style="font-size: 14px">{{$course->numberratefive}}</span>
                            </div>
                            <!-- end 5 -->
                            <div class="col-lg-1 col-xs-3 col-md-3 text-right">
            ...
            @foreach($reviews as $review)
                <li>
                    <div class="user-info" style="display: flex; align-items: center">
                        <div class="avatar" style="width: 40px; height: 40px; border-radius: 100%; overflow: hidden; text-align: center; url('{{ $userInfoMap[$review->user_id]->avatar }}'); background-position: center; background-size: cover">
                    </div>
                        <p class="review-name-user" style="margin-left: 1rem; margin-bottom: 0">{{ $userInfoMap[$review->user_id]->name }}<span class="star" style="margin-left: 1rem"><div class="star-user-rating ">
                            ...
                            @endfor
                        </div></span></p> <p>{{ $review->created_at }}</p>
                    </div>
